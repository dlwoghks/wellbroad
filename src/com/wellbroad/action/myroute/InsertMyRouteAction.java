...
public class InsertMyRouteAction implements BaseAction {
...
//		String tourname[] = request.getParameter("tourname").split("\\|");
		...
		dao.InsertMyRoute(userid,course,coursename,startdate,enddate,days,iconname,icon, nationname, cityname, tourname);
