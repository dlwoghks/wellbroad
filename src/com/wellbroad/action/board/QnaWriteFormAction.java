...
//  /writeForm.do
public class QnaWriteFormAction implements BaseAction {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		// TODO Auto-generated method stub
		 ...
		 int num=0,ref=1,ref_step=0,ref_level=0;
	    ...
	    if(request.getParameter("num")!=null){ //1이상
	    	...
	    	System.out.println
	    	("num="+num+",ref="+ref+",ref_step="+ref_step+",ref_level="+ref_level);
	    }
		...
		return "../board/qna/qnaWriteForm.jsp";
	}
