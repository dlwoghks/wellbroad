...
//   /writePro.do?num=?&,,,,,
public class QnaWriteProAction implements BaseAction {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		// TODO Auto-generated method stub
	     ...
	     article.setRef_step(Integer.parseInt(request.getParameter("ref_step")));
	     article.setRef_level(Integer.parseInt(request.getParameter("ref_level")));
	     ...
	     System.out.println("writerproaction mail값==>>"+request.getParameter("mail"));
