...
<body>
	...
	<div class="sub-main">
		<form method="POST" class="form1" name="delForm" action="noticeDeletePro.do?pageNum=${pageNum}&num=${num}">
					...
					<table class="table1" >
						...
						<tr>
							<td class="buttongroup">
								...
								<input type="button" class="btn btn-info" value="글목록" onclick="document.location.href='noticeList.do?pageNum=${pageNum}'">
							</td>
						</tr>									
				     </table>
				</div>
