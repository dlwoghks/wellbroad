					...
					<div class="grids">
						...
						<div class="panel panel-widget forms-panel">
							<div class="progressbar-heading general-heading">
								<h4><b><img src="../custom/image/bar.png" width="7"/>&nbsp; 도시 추가 </b></h4>
							</div>
							<div class="forms">
								<h3 class="title1"></h3>
								<div class="form-three widget-shadow">
									<form name="tourForm" class="form-horizontal" action="adminTourCityInsertPro.do" method="post">
										<div class="form-group">
											...
											<div class="col-sm-5">
												...
												<p class="help-block" id="error-nation">국가를 선택하세요</p>
											</div>
										</div>
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">도시코드</label>
											<div class="col-sm-5">
												<input type="text" class="form-control1" name="code_city" id="code_city" placeholder="영문으로 입력하세요">
												<p class="help-block" id="error-city">도시코드를 입력하세요</p>
											</div>
											<div class="col-sm-5">
												<button type="button" class="btn btn-sm" onclick="checkCode_City()">중복확인</button>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="btnlist">
									  		...
									  		<input type="button" class="btn col-11" onclick="insertCityCheck()" value="추가">
