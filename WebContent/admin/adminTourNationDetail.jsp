			...
			<div class="main-grid">
				<div class="agile-grids">
					...
					<div class="grids">
						...
						<div class="btnlist">
					  		<button type="button" class="btn col-5" id="back" onclick="location.href='adminTourNation.do'">뒤로가기</button>
					  		<button type="button" class="btn col-11" id="update" onclick="location.href='adminTourNationUpdate.do?code_nation=${nation.code_nation}'">수정</button>
  						</div><!-- /.btnlist -->
						<!-- 입력 -->
						<div class="panel panel-widget forms-panel">
							<div class="progressbar-heading general-heading">
								<h4><b><img src="../custom/image/bar.png" width="7"/>&nbsp; 국가 상세 </b></h4>
							</div>
							<div class="forms">
								<h3 class="title1"></h3>
								<div class="form-three widget-shadow">
									<form name="tourForm" class="form-horizontal">
										<div class="form-group">
											<div class="col-sm-2" align="right"><b>국가코드</b></div>
											<div class="col-sm-5">${nation.code_nation }</div>
										</div>
										<div class="form-group">
