					...
					<div class="grids">
						...
						<div class="panel panel-widget forms-panel">
							<div class="progressbar-heading general-heading">
								<h4><b><img src="../custom/image/bar.png" width="7"/>&nbsp; 도시 수정 </b></h4>
							</div>
							<div class="forms">
								<h3 class="title1"></h3>
								<div class="form-three widget-shadow">
									<form name="tourForm" class="form-horizontal" action="adminTourCityUpdatePro.do" method="post">
										<div class="form-group">
											<label for="selector1" class="col-sm-2 control-label">국가</label>
											<div class="col-sm-5">
												<input type="text" class="form-control1" value="${nation.name}" disabled>														
											</div>
										</div>
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">도시코드</label>
											<div class="col-sm-5"> 
												<input type="text" class="form-control1" value="${city.code_city }" disabled>
												<input type="hidden" class="form-control1" name="code_city" id="code_city" value="${city.code_city }">
											</div>
										</div>
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">도시</label>
											<div class="col-sm-5">
												<input type="text" class="form-control1" name="name" id="name" value="${city.name}" placeholder="한글로 입력하세요">
												<p class="help-block" id="error-name">도시이름을 입력하세요</p>
											</div>
										</div> 
										<div class="form-group">
											<label for="txtarea1" class="col-sm-2 control-label">설명</label>
											<div class="col-sm-8"><textarea name="description" id="description" cols="50" rows="4" class="form-control1" style="height:auto">${city.description }</textarea></div>
										</div>
										<div class="btnlist">
									  		<input type="reset" class="btn col-5" onclick="hideErrorMasseage()" value="초기화">
									  		<input type="button" class="btn col-11" onclick="insertCityCheck()" value="수정">
