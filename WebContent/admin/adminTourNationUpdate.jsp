					...
					<div class="grids">
						...
						<div class="panel panel-widget forms-panel">
							<div class="progressbar-heading general-heading">
								<h4><b><img src="../custom/image/bar.png" width="7"/>&nbsp; 국가 수정 </b></h4>
							</div>
							<div class="forms">
								<h3 class="title1"></h3>
								<div class="form-three widget-shadow">
									<form name="tourForm" class="form-horizontal" action="adminTourNationUpdatePro.do" method="post">
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">국가코드</label>
											<div class="col-sm-5">
												<input type="text" class="form-control1" value="${nation.code_nation}" disabled>
												<input type="hidden" class="form-control1" name="code_nation" id="code_nation" value="${nation.code_nation}">
												<p class="help-block" id="error-nation"></p>
											</div>
										</div>
										<div class="form-group">
											<label for="focusedinput" class="col-sm-2 control-label">국가</label>
											<div class="col-sm-5">
												<input type="text" class="form-control1" name="name" id="name" value="${nation.name}" placeholder="영어로 입력하세요">
											</div>
										</div> 
										<div class="btnlist">
									  		<input type="reset" class="btn col-5" onclick="hideErrorMasseage()" value="초기화">
									  		<input type="button" class="btn col-11" onclick="insertNationCheck()" value="수정">
